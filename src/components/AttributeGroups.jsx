  ...
  return (
    <div className="p-6 bg-[#f5f5f5] min-h-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-medium text-gray-800">Attribute Groups</h1>
          <div className="flex items-center text-sm text-gray-500 mt-1">
            <span>Home</span>
            <span className="mx-2">/</span>
            <span className="text-gray-800">Attribute Groups</span>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden">
        <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
          ...
          <h3 className="text-[15px] font-semibold text-gray-700 uppercase">Add Attribute Group</h3>
        </div>

        <div className="p-6 space-y-6 max-w-4xl">
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <label className="md:w-64 text-sm font-bold text-gray-700 text-right">
              <span className="text-red-500 mr-1">*</span>Attribute Group Name
            </label>
