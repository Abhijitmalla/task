...
const Manufacturers = () => {
  const manufacturers = [
    { name: 'Bakingware', sortOrder: 0 },
    { name: 'BBQ ware', sortOrder: 0 },
    { name: 'Chopping Boards', sortOrder: 0 },
    { name: 'Coffee & teaware', sortOrder: 0 },
    { name: 'Housewares Appliances', sortOrder: 0 }
  ];
  ...
  return (
    <div className="p-6 bg-[#f5f5f5] min-h-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-medium text-gray-800">Manufacturers</h1>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden">
        <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 flex items-center gap-2">
          ...
          <h3 className="text-[15px] font-semibold text-gray-700 uppercase tracking-tight">Manufacturer List</h3>
        </div>
            ...
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200 text-left">
                ...
                <th className="px-4 py-3 font-bold text-gray-700 cursor-pointer hover:text-[#1e91cf] transition-colors">
                  Manufacturer Name <span className="inline-block translate-y-[-1px]">^</span>
                </th>
            ...
            <tbody>
              {manufacturers.map((m, i) => (
                <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right text-gray-500">{m.sortOrder}</td>
